...
def main():
    ...
    parser.add_argument('--input_shape', dest='input_shape', nargs=2, type=int, default=[180, 320])
...
def test_one():
    detector = NanoDetNCNN('../model/nanodet_m.param', '../model/nanodet_m.bin')
    t =time.time()
    img = cv2.imread('../imgs/02_02_187.png')
