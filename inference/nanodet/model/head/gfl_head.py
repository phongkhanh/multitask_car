...
class GFLHead(nn.Module):
    ...
    def loss(self, preds,preds_segment, gt_meta):
        ...
        loss1 = loss_qfl + loss_bbox + loss_dfl
        gt_segment=torch.tensor(gt_segment, dtype=torch.long)
        loss2 =  self.criterion(preds_segment, gt_segment)

        loss= loss1+loss2
        #print('loss_bbx',loss1)
        #print('loss_segment',loss2)
